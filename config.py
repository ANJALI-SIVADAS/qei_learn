...
SUPERSET_WEBSERVER_TIMEOUT = 300  # deprecated
...
#SQLALCHEMY_DATABASE_URI = 'postgresql+psycopg2://postgres:password@localhost:5432/superset_27'

SQLALCHEMY_DATABASE_URI = 'postgresql+psycopg2://postgres:Password!234@localhost:5432/anjali_db'
...
APP_NAME = 'Quick & Easy Insights'

# Uncomment to setup an App icon
APP_ICON = '/static/assets/images/qe-white-transparent-200x43.png'
...
MAPBOX_API_KEY = 'pk.eyJ1IjoibmlzaGFudGhuYXlha2FudGkiLCJhIjoiY2ppZmVjYzhlMGpuMjNxbXl6dHVuajV4OSJ9.Am4QS75ZEv3rs4KP1T1kjA'
...
SMTP_STARTTLS = True
SMTP_SSL = False
SMTP_USER = 'servicedesk@beyondanalysis.net'
SMTP_PORT = 587
SMTP_PASSWORD = 'AH!86now'
SMTP_MAIL_FROM = 'servicedesk@beyondanalysis.net'
